...
// Top-center stack, adapted from the Base UI "Custom position" example:
// toasts grow downward from the top edge and enter/exit upward.
function Toast({
  className,
  swipeDirection = "up",
  ...props
  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        "group/toast pointer-events-auto absolute top-0 right-0 z-[calc(1000-var(--toast-index))] w-full origin-top rounded-xl bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/10 will-change-transform outline-none select-none focus-visible:ring-[3px] focus-visible:ring-ring/50 dark:ring-foreground/20",
