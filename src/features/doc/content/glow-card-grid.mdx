...
<Step>Wrap your component with DialKit controls</Step>

Add parameter dials for card radius, icon effects (blur, saturate, brightness, scale, opacity), and border styling (width, blur, saturate, brightness, contrast).
...
- [Glow effect inspiration by @jh3yy](https://x.com/jh3yy/status/1992003440579662211)
- [Implementation details](https://x.com/jh3yy/status/1992035612619411934)
- [DialKit Documentation](https://joshpuckett.me/dialkit)
