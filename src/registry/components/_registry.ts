    ...
    css: {
      ...
      "@utility prose-ncdai": {
        "@apply prose-headings:tracking-tight prose-headings:text-balance prose-h2:font-semibold":
          {},
        "@apply prose-a:font-normal prose-a:wrap-break-word prose-a:text-foreground prose-a:underline prose-a:decoration-foreground/30 prose-a:decoration-1 prose-a:underline-offset-3 prose-a:transition-colors prose-a:hover:decoration-foreground":
          {},
